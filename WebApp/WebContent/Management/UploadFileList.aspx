<%@ Page Title="" Language="C#" MasterPageFile="~/Templates/Management.Master" AutoEventWireup="true" CodeBehind="UploadFileList.aspx.cs" Inherits="WebApp.WebContent.Management.UploadFileList" %>
    ...
    <asp:Repeater runat="server" ID="MessageList" >
        ...
        <ItemTemplate>
            <tr>
                ...
                <td><%# Eval("Status") %></td>
                <td><asp:LinkButton runat="server" ID='down'  CommandArgument='<%# Eval("UploadFileListID").ToString()+":"+Eval("FileName").ToString()%>' OnClick="download_Click">Get File</asp:LinkButton></td>
            </tr>
        </ItemTemplate>
