<%@ Page Title="" Language="C#" MasterPageFile="~/Templates/Management.Master" AutoEventWireup="true" CodeBehind="EditSupplier.aspx.cs" Inherits="WebApp.WebContent.Management.EditSupplier" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container">
        ...
        <input id="SupplierID" runat="server" type="hidden" />
        <div class="span-20">
...
<asp:Content ID="Content3" ContentPlaceHolderID="FooterContent" runat="server">
    <label id="mes1" runat="server" />
    <label id="mes2" runat="server" />
